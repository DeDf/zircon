...
static void pl011_uart_init(const void* driver_data)
{
...
static void pl011_uart_init_early(const void* driver_data) {
    const bootdata_kernel_driver_t* driver = driver_data;
