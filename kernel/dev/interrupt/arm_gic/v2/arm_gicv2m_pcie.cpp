...
static void arm_gicv2_pcie_init(const void* driver_data) {
    const bootdata_arm_gicv2_driver_t* driver =
                            reinterpret_cast<const bootdata_arm_gicv2_driver_t*>(driver_data);
